...
const InvoiceInput: InvoiceInputComponent = ({
	...
	return (
		<input
			key={key}
			id={id}
			className={`${className} ${style.input} w-full rounded-[4px] border border-grey-1200 bg-grey-1500 px-5 py-4 text-white-full caret-purple-600 outline-none text-h4 focus:border-purple-600`}
			type={type}
			min="0"
