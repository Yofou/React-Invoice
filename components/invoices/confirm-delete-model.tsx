...
const ConfirmDeleteModel: React.FC<ConfirmDeleteModelProps> = ({
	...
	return (
		<Dialog zIndex={20} isOpen={isOpen}>
			<div
				ref={ref}
				className="mx-6 flex max-w-[480px] flex-col gap-3 place-self-center rounded-[8px] bg-grey-1500 p-12"
			>
				<h1 className="text-[24px] font-bold leading-[32px] tracking-[-0.8px] text-white-full">
					Confirm Deletion
				</h1>
